...
function getFontFaceStylesheet(opts) {
    ...
    const url = `${cdnBaseUrl}/porsche-design-system/styles/${cdn === 'cn'
        ? 'font-face.min.cn.beb687c693679a511004e1d16efbbcfe.css'
        : 'font-face.min.beb687c693679a511004e1d16efbbcfe.css'}`;
    return format === 'html'
...
function getMetaTagsAndIconLinks(opts) {
    ...
    const cdnBaseUrl = getCdnBaseUrl();
    const manifestUrlCom = './assets/porsche-design-system/meta-icons/manifest.92dae1f8b6d3d7659494e748f1b844f8.webmanifest';
    const manifestUrlCn = './assets/porsche-design-system/meta-icons/manifest.cn.92dae1f8b6d3d7659494e748f1b844f8.webmanifest';
